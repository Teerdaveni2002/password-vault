...
if not ENCRYPTION_KEY:
    ...
    print(f"Generated new encryption key. Set ENCRYPTION_KEY environment variable to: {ENCRYPTION_KEY}")
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@passwordvault.com')
